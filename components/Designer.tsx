...
function Designer() {
  ...
  useDndMonitor({
    onDragEnd: (event: DragEndEvent) => {
      ...
      // first scenario - drop sidebar element over designer drop area
      ...
      // second scenario - drop sidebar element over other element(in between)
      ...
      // third scenario - arrange/sort designer elements
